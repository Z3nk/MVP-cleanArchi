...
public class MovieRepositoryImpl(val moveRemoteDataSource: MovieRemoteDataSource) :
    MovieRepository {
    override suspend fun getDetailsMovieOf(id: String): Response<MovieEntity> =
        moveRemoteDataSource.getDetailsMovieOf(id)

    override suspend fun getPopularsMovie(): Response<MovieDefinitionEntity> =
        moveRemoteDataSource.getPopularsMovie()
